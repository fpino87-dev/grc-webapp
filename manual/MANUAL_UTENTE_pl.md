...
**Istniejące PDCA, także zamknięte** — ustalenie można powiązać z dowolnym PDCA tego samego zakładu, **nawet już zamkniętym lub zarchiwizowanym**: dotyczy to działania korygującego wykonanego przed zarejestrowaniem ustalenia (np. PDCA otwarty ręcznie na podstawie raportu z audytu) lub odtworzenia historii. Jeśli ustalenie jest otwarte, a PDCA zamknięty, obowiązują opisane niżej zasady zamykania PDCA (przy skutecznym wyniku ustalenie zamyka się od razu); jeśli ustalenie jest już zamknięte, żaden status się nie zmienia (powiązanie wsteczne, rejestrowane jako takie w ścieżce audytu). W menu PDCA przycisk **🔗 Ustalenia** pokazuje wszystkie ustalenia audytu, otwarte i zamknięte.

**Zastąpienie PDCA** — jeśli ustalenie ma już PDCA (dla NC ten otwarty automatycznie), zastępuje się go właściwym, podając powód: z ustalenia przyciskiem **Zastąp PDCA** albo z menu PDCA, wybierając ustalenie (widać, z jakim cyklem jest powiązane). Zastąpiony PDCA jest archiwizowany tylko wtedy, gdy został otwarty automatycznie dla tego ustalenia i nigdy nie był prowadzony; w przeciwnym razie pozostaje bez zmian, tylko odłączony. Dla zamkniętego ustalenia nie otwiera się nowego PDCA — wiąże się je z istniejącym.
...
Jeśli ustalenie ma powiązany PDCA, zamyka się dopiero po zakończeniu działania korygującego: gdy PDCA jest **zamknięty** (lub zarchiwizowany) albo w fazie **ACT**, jeśli obejmuje tylko to ustalenie; wtedy PDCA zamyka się razem z ustaleniem, a uwagi zamknięcia stają się jego standaryzacją. W pozostałych przypadkach system wskazuje fazę PDCA i niczego nie zapisuje. **Zamknięcie z poziomu PDCA** — PDCA zawiera już dowód (faza DO), weryfikację skuteczności (CHECK) i standaryzację (ACT), więc po jego zamknięciu powiązane ustalenia idą za wynikiem CHECK: **skuteczny** → zamykają się razem z nim, z dowodem z fazy DO i opisem ACT jako uwagami zamknięcia (NC wymaga dowodu DO, w przeciwnym razie pozostaje „w odpowiedzi”); **częściowo skuteczny** → przechodzą w stan „w odpowiedzi”, a o zamknięciu decydujesz w zakładce Ustalenia; **nieskuteczny** → przechodzą do nowego cyklu „[Riciclo]” i pozostają otwarte. Nie powstaje dodatkowa lekcja — wystarczy ta z PDCA. Jeśli ustalenie pozostało „w odpowiedzi” przy już zamkniętym PDCA (np. powiązane przed wprowadzeniem tej zasady albo z wynikiem częściowym, który uznajesz za wystarczający), przycisk **Zamknij z PDCA** zamyka je, używając dowodu DO i opisu ACT z PDCA, bez ponownego wpisywania.
...
**Ustalenie niekontynuowane** — dla obserwacji lub szansy, której postanowiono nie realizować, użyj **Nie kontynuuj** na karcie ustalenia. Wpisz powód (wymagany, co najmniej 20 znaków) i, jeśli chcesz, dołącz dowód: plik (np. protokół decyzji) lub istniejący dowód. Ustalenie otrzymuje status **Niekontynuowane**: nie jest już liczone jako otwarte, ale pozostaje odróżnione od zamkniętych w pakiecie audytowym i w przeglądzie zarządzania, który wymienia odrzucone ustalenia wraz z powodem. Powiązany, wciąż otwarty PDCA jest archiwizowany z tym samym powodem; w ustaleniu wspólnym decyzja obowiązuje we wszystkich zakładach. Przyciskiem **Otwórz ponownie** ustalenie wraca do stanu otwartego i otwiera się lub wiąże nowy PDCA. Niezgodności nie można pozostawić bez kontynuacji: podążają za PDCA. Ten sam wynik uzyskasz w module PDCA przyciskiem 📦 **Archiwizuj**: okno prosi o powód i opcjonalny dowód, a powiązane, wciąż otwarte obserwacje i szanse otrzymują status «Niekontynuowane»; powiązane niezgodności pozostają otwarte, o czym okno informuje. W przypadku PDCA bez ustaleń dowód pozostaje przy cyklu i jest widoczny w jego karcie.
