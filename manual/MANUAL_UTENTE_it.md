...
**Rilievo non perseguito** — per un'osservazione o un'opportunità che si decide di non realizzare, usa **Non perseguire** nella card del finding. Scrivi il motivo (obbligatorio, minimo 20 caratteri) e, se vuoi, allega una prova: un file (es. il verbale della decisione) o un'evidenza già presente. Il finding passa a **Non perseguito**: non conta più come aperto, ma resta distinto dai chiusi nel pacchetto audit e nel riesame di direzione, che elenca i rilievi scartati con il motivo. Il PDCA collegato ancora aperto viene archiviato con lo stesso motivo; nel rilievo comune la decisione vale per tutti i siti. Con **Riapri** il rilievo torna aperto e si apre o collega un nuovo PDCA. Le non conformità non si possono non perseguire: seguono il PDCA. Si ottiene lo stesso risultato anche dal modulo PDCA con 📦 **Archivia**: la finestra chiede il motivo e la prova facoltativa, e le osservazioni e opportunità collegate ancora aperte passano a «Non perseguito»; le non conformità collegate restano aperte e la finestra lo segnala. Per un PDCA senza finding la prova resta sul ciclo ed è visibile nella scheda.
