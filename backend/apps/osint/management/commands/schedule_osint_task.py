...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Il vecchio push dei KPI OSINT è sostituito dai connettori interni
        # del KPI engine: se il job esiste ancora lo si toglie.
        PeriodicTask.objects.filter(name="osint-push-kpis").delete()
