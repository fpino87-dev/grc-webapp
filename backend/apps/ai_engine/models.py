...
TASK_TYPES = [
    ...
    ("review_agenda_item", "Discussione punto ordine del giorno Management Review"),
    ("chatbot", "Chatbot Ask GRC"),
    ("control_explain", "Spiegazione plain-language controllo"),
    ("vda_interview", "Intervista guidata VDA ISA (Implementation description)"),
