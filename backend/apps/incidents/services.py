...
def close_incident(incident: Incident, user):
    ...
    # Chiusura incidente = scrittura multi-entità (task NIS2 + save + PDCA + Lesson
    # Learned + audit): tutto o niente, così non restano cicli/lezioni orfani né audit
    # incoerente se una scrittura fallisce a metà.
    ...
    # Notifica NIS2 best-effort: fuori dalla transazione, parte solo a commit avvenuto
    # (evita di notificare una chiusura poi annullata da un rollback).
